...
var statuses = document.querySelectorAll('.status_line'); //get all 5 status 
// console.log(statuses)

var hiddenInput = document.querySelector('#hiddenInput');
var order = hiddenInput ? hiddenInput.value : null;
order = JSON.parse(order); //to show updated time
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      ...
      stepCompleted = false; //time show

      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.uodatedAt).format('hh:mm A');
...
updateStatus(order); //socket connection client side
...
if (adminAreaPath.includes('admin')) {
  (0,_admin_admin__WEBPACK_IMPORTED_MODULE_2__["default"])(socket);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkburger_mania"] = self["webpackChunkburger_mania"] || [];
